...
public class WhileLoop2 {
    ...
    public static void main(String[] args) {
        ...
        String str2 = "";
        while (str2.length() < 5) {
            // you must have a statement that updates the value of a variable that is used in boolean expression
            str2 = str2.concat("*");
        ...
        // Write a program that will print out even numbers until 20

...
public class InstanceMethods {
    ...
    // Static methods are predefined functions that can be used without creating an Object.
    //
    // What is a non-static method?
    // Non-static method is an instance method.
    // In order to use instance methods inside a static method you must first create an object of the class
